...
#  环境变量与全局变量
# ============================================================
EMAIL        = os.environ.get("remote.kwsuper@gmail.com")
PASSWORD     = os.environ.get("@Harvestm00n")
TG_BOT_TOKEN = os.environ.get("6824546525:AAEHD3Tz3DjNUsMNguh18XJiBztvbMG21rk")
TG_CHAT_ID   = os.environ.get("2113813628")
